  ...
  overlay.innerHTML = `
    <div style="background:var(--bg-card);border-radius:8px;display:flex;flex-direction:column;overflow:hidden;border:1px solid var(--border);max-width:95vw;max-height:92vh">
      ...
      <div style="padding:16px;display:flex;align-items:center;justify-content:center;background:#000">
        <!-- 72vh, not 78: the modal is capped at 92vh with overflow:hidden, and the header plus the
             new transport row cost ~12vh — at 78 the skip buttons fell off the bottom on a laptop. -->
        <iframe id="pvpFrame" style="height:72vh;max-width:92vw;aspect-ratio:${aspect()};border:0;background:#000" src="${frameSrc()}"></iframe>
      </div>
